...
-- lQuery("ElemType[id='Class']/compartType[id = 'ASFictitiousAttributes']/subCompartType/subCompartType[id='Name']"):link("translet", lQuery.create("Translet", {extensionPoint = "procGetPrefix", procedureName = "OWLGrEd_UserFields.owl_fields_specific.setAllPrefixesView"}))
...
lQuery("PropertyEventHandler[procedureName='OWLGrEd_XSchema.schema.onAttributeOpen']"):delete()

lQuery("PropertyEventHandler[procedureName='OWLGrEd_XSchema.schema.onAttributeOpen']"):delete()
lQuery("PropertyEventHandler[procedureName='OWLGrEd_XSchema.schema.disablePropertiesOnOpen']"):delete()
lQuery("PropertyEventHandler[procedureName='OWLGrEd_XSchema.schema.onAttributeLinkOpen']"):delete()
