...
function showMesageLogDatabeseInstance()
    ...
    caption = "Close"
	,eventHandler = utilities.d_handler("Click", "lua_engine", "lua.RDB2OWL_AutoCompletion.reGrammar.close()")
  })
  ...
  local form = lQuery.create("D#Form", {
    ...
    ,eventHandler = utilities.d_handler("Close", "lua_engine", "lua.RDB2OWL_AutoCompletion.reGrammar.close()")
	,component = {
		lQuery.create("D#VerticalBox", {
			...
			,component = { 
				...
				,lQuery.create("D#Label", { caption = "run file 'run_form.bat' from project's plugin RDB2OWL_AutoCompletion folder."}) 
			}
		})
		,close_button
    }
