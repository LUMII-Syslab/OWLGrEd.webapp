...
function completeMetamodel()
	...
	local prEH1  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLclassMap"})
	local prEH2  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLdataMap"})
	local prEH3  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLobjectMap"})
	local prEH4  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLobjectMap"})
	local prEH5  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLontologyDBExpr"})
	...
	local prEH6  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLclassMapMultiLineButton"})
	local prEH7  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLdataMapMultiLineButton"})
	local prEH8  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLobjectMapMultiLineButton"})
	local prEH9  = lQuery.create("PropertyEventHandler", {eventType = "onChange", procedureName = "RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLobjectMapMultiLineButton"})
    ...
    -- lQuery.create("Translet", {extensionPoint = 'procDecompose', procedureName = 'RDB2OWL_AutoCompletion.reGrammar.dbexprGrammar'}):link("type", compartType)
	...
	lQuery.create("Translet", {extensionPoint = 'procGetPattern', procedureName = 'RDB2OWL_AutoCompletion.reGrammar.dbexprGrammar'}):link("type", compartType)
...
function addRemoveAutoCompletion(useautocompletion)
	...
	elseif useautocompletion=="0" then 
		...
		lQuery("ElemType[id='Class']/compartType[caption='DBExpr']/propertyRow"):find("/propertyEventHandler[procedureName='RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLclassMapMultiLineButton']"):delete()
		lQuery("ElemType[id='Class']/compartType/subCompartType/subCompartType/subCompartType[caption='DBExpr']/propertyRow"):find("/propertyEventHandler[procedureName='RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLdataMapMultiLineButton']"):delete()
		lQuery("ElemType[id='Association']/compartType[id='Role']/subCompartType/subCompartType[caption='DBExpr']/propertyRow"):find("/propertyEventHandler[procedureName='RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLobjectMapMultiLineButton']"):delete()
		lQuery("ElemType[id='Association']/compartType[id='InvRole']/subCompartType/subCompartType[caption='DBExpr']/propertyRow"):find("/propertyEventHandler[procedureName='RDB2OWL_AutoCompletion.reGrammar.getRDB2OWLobjectMapMultiLineButton']"):delete()
