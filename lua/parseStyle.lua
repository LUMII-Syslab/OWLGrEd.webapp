...
function nodeStyleAttribute()
	return {"shapeCode", "shapeStyle", "lineWidth", "dashLength", "breakLength", "adornment", "bkgColor", "lineColor", "dynamicTooltip", "picture",  
...
function nodeStyleInstance()
	...
	["picStyle"] = 1, ["picPos"] = 1,  ["picWidth"] = 1, ["picHeight"] = 1, ["dynamicTooltip"] = 0}
end
...
function compartStyleAttribute()
	...
	"bkgColor", "lineColor", "width", "height", "xPos", "yPos", "isVisible", "lineStartDirection", "lineEndDirection", "dynamicTooltip", "fontCharSet", "fontPitch", 
	"fontSize",  "fontStyle", "fontColor", "fontTypeFace", "picture", "picStyle", "picPos", "picWidth", "picHeight"}
end
...
function compartStyleInstance()
	...
	["lineStartDirection"] = 1, ["lineEndDirection"] = 1, ["dynamicTooltip"] = 1, ["fontCharSet"] = 1, ["fontPitch"] = 1, ["fontSize"] = 1, ["fontStyle"] = 1,
	["fontColor"] = 1, ["fontTypeFace"] = 1, ["picture"] = 1, ["picStyle"] = 1, ["picPos"] = 1, ["picWidth"] = 1, ["picHeight"] = 1, }
end
...
function parseNodeStyle(text)
	...
	G = lpeg.P{Exp,
		...
		NodeStyle = open * Shape * close * String * separater * open * Picture * close;
...
function parseCompartStyle(text)
	...
	G = lpeg.P{Exp,
		...
		CompartStyle = String * separater * String * separater * String * separater * String * separater * open * Shape * close * 
			String * separater * String * separater * String * separater * String * separater * String * separater * String * separater 
			* String * separater * String * separater * open * Shape * close * 
			open * Picture * close;
		Shape = String * separater * (String * separater) ^ 0;
		Picture = String * separater * (String * separater) ^ 0 + separater;
	}
